...
grep 'ref=ea02a3bec8091dbae5bb59fec5297c48f2ff7349' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ea02a3bec8091dbae5bb59fec5297c48f2ff7349[a-z0-9]*/${root}\/\2/g" "${file}"
done
