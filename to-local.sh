...
grep 'ref=e70851edd3c01093f92e20df714f7b0b9d551611' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e70851edd3c01093f92e20df714f7b0b9d551611[a-z0-9]*/${root}\/\2/g" "${file}"
done
