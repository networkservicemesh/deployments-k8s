...
grep 'ref=edda669c662cfa369a17fbb87f6f9cfddd8150a3' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=edda669c662cfa369a17fbb87f6f9cfddd8150a3[a-z0-9]*/${root}\/\2/g" "${file}"
done
