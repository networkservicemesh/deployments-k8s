...
grep 'ref=927e7d4ad3bb83cf45dcc443886c39ef69a7a51d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=927e7d4ad3bb83cf45dcc443886c39ef69a7a51d[a-z0-9]*/${root}\/\2/g" "${file}"
done
