...
grep 'ref=35e9b325e4b717a86f3483c85ade8089647e764f' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=35e9b325e4b717a86f3483c85ade8089647e764f[a-z0-9]*/${root}\/\2/g" "${file}"
done
