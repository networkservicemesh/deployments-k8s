...
grep 'ref=bb8479a9291ab457255423f7164320767bb94ae1' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=bb8479a9291ab457255423f7164320767bb94ae1[a-z0-9]*/${root}\/\2/g" "${file}"
done
