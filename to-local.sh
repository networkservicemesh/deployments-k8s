...
grep '?ref=e03a1b7b8d986b8095e9b8c755a30c5b83707435' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e03a1b7b8d986b8095e9b8c755a30c5b83707435/${root}\/\2/g" "${file}"
done
