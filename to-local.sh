...
grep '?ref=e0cd69f1412dbc33a6a7a00a2590e54553cc4bd7' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e0cd69f1412dbc33a6a7a00a2590e54553cc4bd7/${root}\/\2/g" "${file}"
done
