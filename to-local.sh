...
grep '?ref=f733a07d11fc76244ae08afd6304d8e80ea6410c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f733a07d11fc76244ae08afd6304d8e80ea6410c/${root}\/\2/g" "${file}"
done
