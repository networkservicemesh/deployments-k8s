...
grep 'ref=7384ba35397eb7968ae0e99599aed652cb954365' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7384ba35397eb7968ae0e99599aed652cb954365[a-z0-9]*/${root}\/\2/g" "${file}"
done
