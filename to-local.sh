...
grep '?ref=84deb100ee90be737a93de9b0f88dcd5cca36870' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=84deb100ee90be737a93de9b0f88dcd5cca36870/${root}\/\2/g" "${file}"
done
