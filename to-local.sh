...
grep 'ref=604f324d51288159d6ec80f1e84fc3f741b69e53' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=604f324d51288159d6ec80f1e84fc3f741b69e53[a-z0-9]*/${root}\/\2/g" "${file}"
done
