...
grep 'ref=ba063fd059b7051bd7ee44c3beca1cea64f0229b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ba063fd059b7051bd7ee44c3beca1cea64f0229b[a-z0-9]*/${root}\/\2/g" "${file}"
done
