...
grep 'ref=ea6a66412ef4d39498b55bf38cfe2e5ccc23a1cf' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ea6a66412ef4d39498b55bf38cfe2e5ccc23a1cf[a-z0-9]*/${root}\/\2/g" "${file}"
done
