...
grep 'ref=7f2aadadab5095565d05c80860e47422a9874c4b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7f2aadadab5095565d05c80860e47422a9874c4b[a-z0-9]*/${root}\/\2/g" "${file}"
done
