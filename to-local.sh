...
grep 'ref=e012b3cf1e327c3a32df97cf1137d6cb45240c7f' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e012b3cf1e327c3a32df97cf1137d6cb45240c7f[a-z0-9]*/${root}\/\2/g" "${file}"
done
