...
grep 'ref=953a8195d11fe5feae8870ef9b597e78111f0cf0' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=953a8195d11fe5feae8870ef9b597e78111f0cf0[a-z0-9]*/${root}\/\2/g" "${file}"
done
