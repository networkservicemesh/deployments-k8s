...
grep 'ref=e1a35f7b0cce51d7a7edfc27fe067ab17dc1c836' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e1a35f7b0cce51d7a7edfc27fe067ab17dc1c836[a-z0-9]*/${root}\/\2/g" "${file}"
done
