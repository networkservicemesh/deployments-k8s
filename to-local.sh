...
grep 'ref=7d6f6c93d377a1a2b6ae1238aec39a6d04668509' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7d6f6c93d377a1a2b6ae1238aec39a6d04668509[a-z0-9]*/${root}\/\2/g" "${file}"
done
