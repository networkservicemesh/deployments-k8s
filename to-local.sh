...
grep 'ref=45310177d4b4a7c89027383cdc2a7632b98c3606' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=45310177d4b4a7c89027383cdc2a7632b98c3606[a-z0-9]*/${root}\/\2/g" "${file}"
done
