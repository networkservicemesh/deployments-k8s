...
grep 'ref=2268bd62c0acfea5213a6b270565fa18ec06a1ff' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2268bd62c0acfea5213a6b270565fa18ec06a1ff[a-z0-9]*/${root}\/\2/g" "${file}"
done
