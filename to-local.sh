...
grep 'ref=9a92f8611a53e15cca0d83ae28e9d518014c397a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9a92f8611a53e15cca0d83ae28e9d518014c397a[a-z0-9]*/${root}\/\2/g" "${file}"
done
