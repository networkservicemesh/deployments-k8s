...
grep 'ref=74abad3e0cfc2f78bc43d70cf0aa57f9e9358eaf' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=74abad3e0cfc2f78bc43d70cf0aa57f9e9358eaf[a-z0-9]*/${root}\/\2/g" "${file}"
done
