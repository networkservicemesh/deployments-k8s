...
grep 'ref=6857bff230c3d2306fa3a15d3eefbd2c533154f9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6857bff230c3d2306fa3a15d3eefbd2c533154f9[a-z0-9]*/${root}\/\2/g" "${file}"
done
