...
grep 'ref=42bd05782e685a32765edd05e4ec2312fcb1f71d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=42bd05782e685a32765edd05e4ec2312fcb1f71d[a-z0-9]*/${root}\/\2/g" "${file}"
done
