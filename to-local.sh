...
grep 'ref=7be52e47e136c606a141b091c740b7a924e53597' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7be52e47e136c606a141b091c740b7a924e53597[a-z0-9]*/${root}\/\2/g" "${file}"
done
