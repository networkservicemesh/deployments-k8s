...
grep 'ref=cedd1a0e7befa3e188870cfa3e6200a7199178be' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=cedd1a0e7befa3e188870cfa3e6200a7199178be[a-z0-9]*/${root}\/\2/g" "${file}"
done
