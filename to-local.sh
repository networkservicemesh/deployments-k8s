...
grep 'ref=103f0149508a5dbbb776b9d7941c28f326d146ed' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=103f0149508a5dbbb776b9d7941c28f326d146ed[a-z0-9]*/${root}\/\2/g" "${file}"
done
