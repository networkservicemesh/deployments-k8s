...
grep 'ref=fefed4ebaaaa340051aba475f519c15b0bd4dfa9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=fefed4ebaaaa340051aba475f519c15b0bd4dfa9[a-z0-9]*/${root}\/\2/g" "${file}"
done
