...
grep 'ref=f77537a8c3b589dbcab87cc9b834349dc9439fc9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f77537a8c3b589dbcab87cc9b834349dc9439fc9[a-z0-9]*/${root}\/\2/g" "${file}"
done
