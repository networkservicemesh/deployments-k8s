...
grep 'ref=a532ae495bf089dbc1b348a78043e5709d8a1a77' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a532ae495bf089dbc1b348a78043e5709d8a1a77[a-z0-9]*/${root}\/\2/g" "${file}"
done
