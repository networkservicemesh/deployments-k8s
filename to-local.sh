...
grep 'ref=e04db20a573e6218d37f6d7c31f4f7c77f7f49f4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e04db20a573e6218d37f6d7c31f4f7c77f7f49f4[a-z0-9]*/${root}\/\2/g" "${file}"
done
