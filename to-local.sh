...
grep '?ref=921cfdada783c66e5917c7700fd3b677fc79b3fe' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=921cfdada783c66e5917c7700fd3b677fc79b3fe/${root}\/\2/g" "${file}"
done
