...
grep 'ref=b7056d68664df97f1ae3979e28c36fa2592911a4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=b7056d68664df97f1ae3979e28c36fa2592911a4[a-z0-9]*/${root}\/\2/g" "${file}"
done
