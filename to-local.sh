...
grep 'ref=97fec329669421a25acb98d5e9ca82a747d76de2' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=97fec329669421a25acb98d5e9ca82a747d76de2[a-z0-9]*/${root}\/\2/g" "${file}"
done
