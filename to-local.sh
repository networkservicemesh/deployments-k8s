...
grep '?ref=387ff290c8751fdc793ff6e94e3ce0d79b114023' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=387ff290c8751fdc793ff6e94e3ce0d79b114023/${root}\/\2/g" "${file}"
done
