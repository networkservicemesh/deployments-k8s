...
grep 'ref=02b35de591b499af52e28c779a653322547b4867' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=02b35de591b499af52e28c779a653322547b4867[a-z0-9]*/${root}\/\2/g" "${file}"
done
