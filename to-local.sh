...
grep '?ref=689ff57be1ba552cdb10aa56a9ee809da0e0ecbf' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=689ff57be1ba552cdb10aa56a9ee809da0e0ecbf/${root}\/\2/g" "${file}"
done
