...
grep 'ref=ece0e6fc7315874b6f2914623b88c0c1ac5cf332' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ece0e6fc7315874b6f2914623b88c0c1ac5cf332[a-z0-9]*/${root}\/\2/g" "${file}"
done
