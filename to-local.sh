...
grep 'ref=fb9aa235d4f16e26f0021b9ed84c40b1c025f958' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=fb9aa235d4f16e26f0021b9ed84c40b1c025f958[a-z0-9]*/${root}\/\2/g" "${file}"
done
