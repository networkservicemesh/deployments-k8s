...
grep 'ref=ea75874423813ad85b4939e0cf2d3d09bd51732a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ea75874423813ad85b4939e0cf2d3d09bd51732a[a-z0-9]*/${root}\/\2/g" "${file}"
done
