...
grep 'ref=d6216c2130592067e8dcbab1fdbe2bbe257154ed' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d6216c2130592067e8dcbab1fdbe2bbe257154ed[a-z0-9]*/${root}\/\2/g" "${file}"
done
