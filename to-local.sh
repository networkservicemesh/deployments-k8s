...
grep '?ref=78e553a66ad65002e7ab8b5bcf0fae216e514a73' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=78e553a66ad65002e7ab8b5bcf0fae216e514a73/${root}\/\2/g" "${file}"
done
