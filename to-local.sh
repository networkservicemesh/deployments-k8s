...
grep 'ref=2bca55042ddf4aec3eb990770c1c41da4061cf3e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2bca55042ddf4aec3eb990770c1c41da4061cf3e[a-z0-9]*/${root}\/\2/g" "${file}"
done
