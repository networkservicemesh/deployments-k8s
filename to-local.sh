...
grep 'ref=d965ec819b1794083ae5d3b096c53404ce18228e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d965ec819b1794083ae5d3b096c53404ce18228e[a-z0-9]*/${root}\/\2/g" "${file}"
done
