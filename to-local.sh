...
grep 'ref=d8649e24fd864ff0a7c06d8241fe7c05c51866e1' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d8649e24fd864ff0a7c06d8241fe7c05c51866e1[a-z0-9]*/${root}\/\2/g" "${file}"
done
