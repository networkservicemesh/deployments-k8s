...
grep 'ref=97c01692b2a62e88e01154a58719e4470c9a170d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=97c01692b2a62e88e01154a58719e4470c9a170d[a-z0-9]*/${root}\/\2/g" "${file}"
done
