...
grep 'ref=33a3adee2da274f02c6a022d1cd6507c58b8b08d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=33a3adee2da274f02c6a022d1cd6507c58b8b08d[a-z0-9]*/${root}\/\2/g" "${file}"
done
