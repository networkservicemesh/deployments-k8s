...
grep 'ref=a40cc809f98d946f2311853cd5b489aeab4c3e63' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a40cc809f98d946f2311853cd5b489aeab4c3e63[a-z0-9]*/${root}\/\2/g" "${file}"
done
