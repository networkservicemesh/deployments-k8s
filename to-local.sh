...
grep 'ref=5752a94f8c89b43ca6075f341a96fdb284733bc7' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=5752a94f8c89b43ca6075f341a96fdb284733bc7[a-z0-9]*/${root}\/\2/g" "${file}"
done
