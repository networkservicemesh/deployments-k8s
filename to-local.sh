...
grep 'ref=1e1b59befbb0d9b61fda026be311b2936fe94704' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1e1b59befbb0d9b61fda026be311b2936fe94704[a-z0-9]*/${root}\/\2/g" "${file}"
done
