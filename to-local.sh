...
grep '?ref=54be5919503470fa8b3370bcc5e7f17dbc7df6b2' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=54be5919503470fa8b3370bcc5e7f17dbc7df6b2/${root}\/\2/g" "${file}"
done
