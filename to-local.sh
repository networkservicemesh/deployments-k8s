...
grep 'ref=fe201b5389cd333f5b5b4476de58a5f10d535f5a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=fe201b5389cd333f5b5b4476de58a5f10d535f5a[a-z0-9]*/${root}\/\2/g" "${file}"
done
