...
grep 'ref=fd8caf87394928da7c8061da73f822ed4450ba58' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=fd8caf87394928da7c8061da73f822ed4450ba58[a-z0-9]*/${root}\/\2/g" "${file}"
done
