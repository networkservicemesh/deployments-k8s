...
grep 'ref=52d94438264012d325f9fba0cc91f332f83bf868' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=52d94438264012d325f9fba0cc91f332f83bf868[a-z0-9]*/${root}\/\2/g" "${file}"
done
