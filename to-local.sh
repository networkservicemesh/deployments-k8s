...
grep 'ref=5fedd8e0e1ef8c4b0f9cf33b686393e4980b2d06' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=5fedd8e0e1ef8c4b0f9cf33b686393e4980b2d06[a-z0-9]*/${root}\/\2/g" "${file}"
done
