...
grep 'ref=8b63b47b403b743dfa26a9bfbf294004dcd000c2' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=8b63b47b403b743dfa26a9bfbf294004dcd000c2[a-z0-9]*/${root}\/\2/g" "${file}"
done
