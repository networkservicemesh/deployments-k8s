...
grep 'ref=c243a7ab4044837adb301bf49b446a66b5e9a3ef' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c243a7ab4044837adb301bf49b446a66b5e9a3ef[a-z0-9]*/${root}\/\2/g" "${file}"
done
