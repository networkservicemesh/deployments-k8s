...
grep 'ref=da720abe5a4c7a19051f37a3eab21b0544aa3f07' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=da720abe5a4c7a19051f37a3eab21b0544aa3f07[a-z0-9]*/${root}\/\2/g" "${file}"
done
