...
grep 'ref=1235267f9386145eede1e37d833a8a9c0db327fb' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1235267f9386145eede1e37d833a8a9c0db327fb[a-z0-9]*/${root}\/\2/g" "${file}"
done
