...
grep 'ref=c1e7903a79777b53d71dbf11df0aca90c8a5cf1c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c1e7903a79777b53d71dbf11df0aca90c8a5cf1c[a-z0-9]*/${root}\/\2/g" "${file}"
done
