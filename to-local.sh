...
grep 'ref=46009eb81a56ef31ccade1f8a245eb4cf1861894' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=46009eb81a56ef31ccade1f8a245eb4cf1861894[a-z0-9]*/${root}\/\2/g" "${file}"
done
