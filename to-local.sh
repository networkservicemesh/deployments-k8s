...
grep 'ref=53fba09265312ec570098fb92866d24464a29f9f' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=53fba09265312ec570098fb92866d24464a29f9f[a-z0-9]*/${root}\/\2/g" "${file}"
done
