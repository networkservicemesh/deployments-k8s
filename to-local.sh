...
grep 'ref=f6377a3745be2fe12e03423e57d31b5e36a112b0' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f6377a3745be2fe12e03423e57d31b5e36a112b0[a-z0-9]*/${root}\/\2/g" "${file}"
done
