...
grep 'ref=75fd9e55582aa89bab779d1e51494da2024dba85' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=75fd9e55582aa89bab779d1e51494da2024dba85[a-z0-9]*/${root}\/\2/g" "${file}"
done
