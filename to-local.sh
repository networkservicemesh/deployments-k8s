...
grep 'ref=9059fd302d693fe62b0f2f30553424fde56d14ab' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9059fd302d693fe62b0f2f30553424fde56d14ab[a-z0-9]*/${root}\/\2/g" "${file}"
done
