...
grep 'ref=e5f3dfc76ae527b29be184940088b50d9a6d0ff4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e5f3dfc76ae527b29be184940088b50d9a6d0ff4[a-z0-9]*/${root}\/\2/g" "${file}"
done
