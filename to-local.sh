...
grep 'ref=83bcd1ff5279bc7d3c62e2275baaf557be34b60c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=83bcd1ff5279bc7d3c62e2275baaf557be34b60c[a-z0-9]*/${root}\/\2/g" "${file}"
done
