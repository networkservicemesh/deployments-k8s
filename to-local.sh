...
grep '?ref=1344e39b68f7834076d84e65bb0e2867ab19d258' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1344e39b68f7834076d84e65bb0e2867ab19d258/${root}\/\2/g" "${file}"
done
