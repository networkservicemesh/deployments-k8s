...
grep '?ref=0bf6d7db1cca81a3eece0093c1060f499e14ed0f' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=0bf6d7db1cca81a3eece0093c1060f499e14ed0f/${root}\/\2/g" "${file}"
done
