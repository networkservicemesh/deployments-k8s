...
grep 'ref=0efb850804eceac6cce140caaa624631f07209d0' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=0efb850804eceac6cce140caaa624631f07209d0[a-z0-9]*/${root}\/\2/g" "${file}"
done
