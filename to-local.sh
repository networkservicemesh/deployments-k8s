...
grep 'ref=c8d2995fa18e14f3d947b8dc7a6ba069be50e5c7' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c8d2995fa18e14f3d947b8dc7a6ba069be50e5c7[a-z0-9]*/${root}\/\2/g" "${file}"
done
