...
grep 'ref=8664b61b58af4c75d25ef01a4795d6e0f169abff' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=8664b61b58af4c75d25ef01a4795d6e0f169abff[a-z0-9]*/${root}\/\2/g" "${file}"
done
