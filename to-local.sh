...
grep 'ref=4b5cfa1c13a3aca0b0b1ca3a6838b7d14979be5b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=4b5cfa1c13a3aca0b0b1ca3a6838b7d14979be5b[a-z0-9]*/${root}\/\2/g" "${file}"
done
