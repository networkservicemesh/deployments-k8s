...
grep 'ref=6c22063ce54ca22e8bff100d4c4bec35d5a10228' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6c22063ce54ca22e8bff100d4c4bec35d5a10228[a-z0-9]*/${root}\/\2/g" "${file}"
done
