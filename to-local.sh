...
grep 'ref=ad1b0b9f8403b40668cac1a5ee6969bf1cdd6d4b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ad1b0b9f8403b40668cac1a5ee6969bf1cdd6d4b[a-z0-9]*/${root}\/\2/g" "${file}"
done
