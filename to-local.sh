...
grep 'ref=d25c117548f259657632fd7c4448db00ead59dc9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d25c117548f259657632fd7c4448db00ead59dc9[a-z0-9]*/${root}\/\2/g" "${file}"
done
