...
grep 'ref=416750e0be70da2e19b910b89e8ce165cc136287' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=416750e0be70da2e19b910b89e8ce165cc136287[a-z0-9]*/${root}\/\2/g" "${file}"
done
