...
grep 'ref=257a20a7ee2d27e4a23a3bce1546789da2431981' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=257a20a7ee2d27e4a23a3bce1546789da2431981[a-z0-9]*/${root}\/\2/g" "${file}"
done
