...
grep 'ref=5dd55851bf8be5cac1b087f82d4dd7d902e6e544' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=5dd55851bf8be5cac1b087f82d4dd7d902e6e544[a-z0-9]*/${root}\/\2/g" "${file}"
done
