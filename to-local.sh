...
grep 'ref=81389c08776e5970aeb995fcaf23657dc0c64ab4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=81389c08776e5970aeb995fcaf23657dc0c64ab4[a-z0-9]*/${root}\/\2/g" "${file}"
done
