...
grep 'ref=efc045327f57b682597ff786551a99a2d98ac6a4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=efc045327f57b682597ff786551a99a2d98ac6a4[a-z0-9]*/${root}\/\2/g" "${file}"
done
