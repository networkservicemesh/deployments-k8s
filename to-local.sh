...
grep '?ref=6bc1cbd589ff3ee144e2dac99d348523e1590310' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6bc1cbd589ff3ee144e2dac99d348523e1590310/${root}\/\2/g" "${file}"
done
