...
grep 'ref=eaff64ec9ce46fc4861de313316ebb617c051cfc' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=eaff64ec9ce46fc4861de313316ebb617c051cfc[a-z0-9]*/${root}\/\2/g" "${file}"
done
