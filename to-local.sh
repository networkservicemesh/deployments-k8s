...
grep 'ref=581b72f5e2241929cd7e0350c25ec90ac8af87ab' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=581b72f5e2241929cd7e0350c25ec90ac8af87ab[a-z0-9]*/${root}\/\2/g" "${file}"
done
