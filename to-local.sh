...
grep 'ref=743a6ec66af1bb103e8501fcf560c3b1a0dbcd9d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=743a6ec66af1bb103e8501fcf560c3b1a0dbcd9d[a-z0-9]*/${root}\/\2/g" "${file}"
done
