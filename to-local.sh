...
grep '?ref=ee3b5b4743df917dccb9ba439f269ab46c5d5f2b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ee3b5b4743df917dccb9ba439f269ab46c5d5f2b/${root}\/\2/g" "${file}"
done
