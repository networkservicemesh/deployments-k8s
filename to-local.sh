...
grep 'ref=411a11ebd2b99018840928c8c6ea819611f7c9fa' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=411a11ebd2b99018840928c8c6ea819611f7c9fa[a-z0-9]*/${root}\/\2/g" "${file}"
done
