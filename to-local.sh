...
grep 'ref=620b8317903ee40de8eac757ba88be1df1498f36' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=620b8317903ee40de8eac757ba88be1df1498f36[a-z0-9]*/${root}\/\2/g" "${file}"
done
