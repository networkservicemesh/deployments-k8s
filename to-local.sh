...
grep 'ref=34143e072b47522821c197eda9de860860876881' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=34143e072b47522821c197eda9de860860876881[a-z0-9]*/${root}\/\2/g" "${file}"
done
