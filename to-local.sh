...
grep '?ref=96e849ea1f5cee4d4f8cb5b8e85adac4ed4fbf70' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=96e849ea1f5cee4d4f8cb5b8e85adac4ed4fbf70/${root}\/\2/g" "${file}"
done
