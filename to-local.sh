...
grep 'ref=f987a87cda08011a1d5f5d0d553e759226b185ed' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f987a87cda08011a1d5f5d0d553e759226b185ed[a-z0-9]*/${root}\/\2/g" "${file}"
done
