...
grep 'ref=a161382a0fa34fffc2d0807c161b54e09142de47' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a161382a0fa34fffc2d0807c161b54e09142de47[a-z0-9]*/${root}\/\2/g" "${file}"
done
