...
grep 'ref=050f0cfdcaf31c2352c8bd622ca1fa6489e5b4db' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=050f0cfdcaf31c2352c8bd622ca1fa6489e5b4db[a-z0-9]*/${root}\/\2/g" "${file}"
done
