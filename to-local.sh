...
grep 'ref=6611fd4bfa8ebe3befd2882dc81c63cf852c2a39' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6611fd4bfa8ebe3befd2882dc81c63cf852c2a39[a-z0-9]*/${root}\/\2/g" "${file}"
done
