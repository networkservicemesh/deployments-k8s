...
grep 'ref=9852d368506d1aecebbfb81b8d89038a895ab340' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9852d368506d1aecebbfb81b8d89038a895ab340[a-z0-9]*/${root}\/\2/g" "${file}"
done
