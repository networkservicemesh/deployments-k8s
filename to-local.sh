...
grep 'ref=eb612112d2c0d5759e26aa58cd76d8da42e987b9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=eb612112d2c0d5759e26aa58cd76d8da42e987b9[a-z0-9]*/${root}\/\2/g" "${file}"
done
