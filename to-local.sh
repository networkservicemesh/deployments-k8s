...
grep '?ref=32e2482c14a324d9fa4d137ce8d79942c50fa566' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=32e2482c14a324d9fa4d137ce8d79942c50fa566/${root}\/\2/g" "${file}"
done
