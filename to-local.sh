...
grep 'ref=9b1e648ce11eb13bed9b379f36d43e62f29c1efb' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9b1e648ce11eb13bed9b379f36d43e62f29c1efb[a-z0-9]*/${root}\/\2/g" "${file}"
done
