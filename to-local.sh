...
grep 'ref=018ad93caee13835392e9ba15a7557294dae4df1' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=018ad93caee13835392e9ba15a7557294dae4df1[a-z0-9]*/${root}\/\2/g" "${file}"
done
