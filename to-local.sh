...
grep 'ref=c5bc13112718e07ba0d76464e5819e5c6178d6f4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c5bc13112718e07ba0d76464e5819e5c6178d6f4[a-z0-9]*/${root}\/\2/g" "${file}"
done
