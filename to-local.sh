...
grep 'ref=4a1691aeb27d1fcc7547bb8db92188fcf70959f6' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=4a1691aeb27d1fcc7547bb8db92188fcf70959f6[a-z0-9]*/${root}\/\2/g" "${file}"
done
