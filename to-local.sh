...
grep 'ref=dbaa71ee58054ef24abdbd0442e318e4a213c29c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=dbaa71ee58054ef24abdbd0442e318e4a213c29c[a-z0-9]*/${root}\/\2/g" "${file}"
done
