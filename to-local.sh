...
grep 'ref=95b887222350f6e323778a068235886acb61dd28' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=95b887222350f6e323778a068235886acb61dd28[a-z0-9]*/${root}\/\2/g" "${file}"
done
