...
grep 'ref=a31f994ac4b5754da7f719450489cd36112b42f8' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a31f994ac4b5754da7f719450489cd36112b42f8[a-z0-9]*/${root}\/\2/g" "${file}"
done
