...
grep 'ref=7f850d7ab6704e71c70194a8c4170874caa9aa47' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7f850d7ab6704e71c70194a8c4170874caa9aa47[a-z0-9]*/${root}\/\2/g" "${file}"
done
