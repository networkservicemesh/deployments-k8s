...
grep 'ref=4bc673adc8e46c042431d0c96b573cff118f4590' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=4bc673adc8e46c042431d0c96b573cff118f4590[a-z0-9]*/${root}\/\2/g" "${file}"
done
