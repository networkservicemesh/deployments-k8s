...
grep 'ref=a2fc4ebaa006026dafa043b4952498d40824481a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a2fc4ebaa006026dafa043b4952498d40824481a[a-z0-9]*/${root}\/\2/g" "${file}"
done
