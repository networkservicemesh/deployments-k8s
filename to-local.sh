...
grep 'ref=bd2d2e62ca61cb0866d86ffa0d87a66c89deb705' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=bd2d2e62ca61cb0866d86ffa0d87a66c89deb705[a-z0-9]*/${root}\/\2/g" "${file}"
done
