...
grep 'ref=3efdb9a3a9f0bdebd7d844a3c26fd8a5663f828c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3efdb9a3a9f0bdebd7d844a3c26fd8a5663f828c[a-z0-9]*/${root}\/\2/g" "${file}"
done
