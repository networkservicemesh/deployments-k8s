...
grep 'ref=711925c09ab7a8e3e645787147fdfcadf1e64120' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=711925c09ab7a8e3e645787147fdfcadf1e64120[a-z0-9]*/${root}\/\2/g" "${file}"
done
