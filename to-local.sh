...
grep 'ref=f1ac38126fccd6b12dc80d2426094d8fb63ec129' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f1ac38126fccd6b12dc80d2426094d8fb63ec129[a-z0-9]*/${root}\/\2/g" "${file}"
done
