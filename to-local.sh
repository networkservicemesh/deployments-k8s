...
grep 'ref=34d9844e7d03cd27f025eb8f52a554ec4e20fae2' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=34d9844e7d03cd27f025eb8f52a554ec4e20fae2[a-z0-9]*/${root}\/\2/g" "${file}"
done
