...
grep 'ref=2070fdc5ebae681dbe4c9aac29efbedd6a171cef' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2070fdc5ebae681dbe4c9aac29efbedd6a171cef[a-z0-9]*/${root}\/\2/g" "${file}"
done
