...
grep 'ref=6d4dfe811d868cb308aaaad7e86352471a5059c4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6d4dfe811d868cb308aaaad7e86352471a5059c4[a-z0-9]*/${root}\/\2/g" "${file}"
done
