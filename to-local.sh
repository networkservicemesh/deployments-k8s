...
grep '?ref=14c9ee13e09b196e4c5cd84eef918366c60b099e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=14c9ee13e09b196e4c5cd84eef918366c60b099e/${root}\/\2/g" "${file}"
done
