...
grep '?ref=7eff79e4ec6defaffd97028f86f3247c8ae242b7' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7eff79e4ec6defaffd97028f86f3247c8ae242b7/${root}\/\2/g" "${file}"
done
