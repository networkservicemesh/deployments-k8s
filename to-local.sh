...
grep 'ref=946a844e033ffd6d7ea04393bab4090bb35253af' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=946a844e033ffd6d7ea04393bab4090bb35253af[a-z0-9]*/${root}\/\2/g" "${file}"
done
