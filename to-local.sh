...
grep 'ref=349c5e5061bb801105b4778ded62279d87a699f9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=349c5e5061bb801105b4778ded62279d87a699f9[a-z0-9]*/${root}\/\2/g" "${file}"
done
