...
grep '?ref=a5ff341a0e59a618a1d023f2b635cbd4e3ccea7e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a5ff341a0e59a618a1d023f2b635cbd4e3ccea7e/${root}\/\2/g" "${file}"
done
