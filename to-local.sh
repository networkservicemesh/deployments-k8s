...
grep 'ref=5b1e5249caf72e77e47209e1fa8a5332a6a5232b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=5b1e5249caf72e77e47209e1fa8a5332a6a5232b[a-z0-9]*/${root}\/\2/g" "${file}"
done
