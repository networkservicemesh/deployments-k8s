...
grep 'ref=236b98994a09d6b5b94e64a240c961f6a09adf3d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=236b98994a09d6b5b94e64a240c961f6a09adf3d[a-z0-9]*/${root}\/\2/g" "${file}"
done
