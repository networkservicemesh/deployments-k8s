...
grep 'ref=802e6bc3de837495c8044e49b303621d2a3faba5' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=802e6bc3de837495c8044e49b303621d2a3faba5[a-z0-9]*/${root}\/\2/g" "${file}"
done
