...
grep 'ref=80d3265c42c78c3f699b9f7d4ba47e014f204324' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=80d3265c42c78c3f699b9f7d4ba47e014f204324[a-z0-9]*/${root}\/\2/g" "${file}"
done
