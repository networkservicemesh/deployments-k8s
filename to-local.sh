...
grep 'ref=3c5fe8c1bb27318aa4896479e6358cb8128014aa' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3c5fe8c1bb27318aa4896479e6358cb8128014aa[a-z0-9]*/${root}\/\2/g" "${file}"
done
