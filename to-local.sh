...
grep '?ref=58e4e3981c3cd4fc45196bcb11e25248f80a2298' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=58e4e3981c3cd4fc45196bcb11e25248f80a2298/${root}\/\2/g" "${file}"
done
