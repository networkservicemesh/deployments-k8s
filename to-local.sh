...
grep 'ref=2300e586b00a58110511e70b2266f33c9da61616' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2300e586b00a58110511e70b2266f33c9da61616[a-z0-9]*/${root}\/\2/g" "${file}"
done
