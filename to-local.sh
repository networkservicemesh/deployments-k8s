...
grep 'ref=d32cad3f00a6d87e5c2b95f1603aa14e42ffbadc' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d32cad3f00a6d87e5c2b95f1603aa14e42ffbadc[a-z0-9]*/${root}\/\2/g" "${file}"
done
