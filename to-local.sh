...
grep 'ref=767896724e58e957c862b644dbc71caab7d31f9e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=767896724e58e957c862b644dbc71caab7d31f9e[a-z0-9]*/${root}\/\2/g" "${file}"
done
