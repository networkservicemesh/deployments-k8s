...
grep 'ref=5323b7e955041d752335d788b97452c1497b4378' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=5323b7e955041d752335d788b97452c1497b4378[a-z0-9]*/${root}\/\2/g" "${file}"
done
