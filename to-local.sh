...
grep 'ref=237d5b0cc19359a39ef593572ccd4b0c78075701' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=237d5b0cc19359a39ef593572ccd4b0c78075701[a-z0-9]*/${root}\/\2/g" "${file}"
done
