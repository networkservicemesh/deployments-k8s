...
grep 'ref=bc4459b7cb79c0e521774a0de85103a677ed9917' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=bc4459b7cb79c0e521774a0de85103a677ed9917[a-z0-9]*/${root}\/\2/g" "${file}"
done
