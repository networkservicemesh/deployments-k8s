...
grep 'ref=bda8770f0cf477cf9db33c7e758f958b24e12684' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=bda8770f0cf477cf9db33c7e758f958b24e12684[a-z0-9]*/${root}\/\2/g" "${file}"
done
