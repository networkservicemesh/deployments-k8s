...
grep 'ref=03b6fcb1a430a4e1281ba52a1d11adf419e75bef' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=03b6fcb1a430a4e1281ba52a1d11adf419e75bef[a-z0-9]*/${root}\/\2/g" "${file}"
done
