...
grep 'ref=1bb225f62190aebd9d00b5ac0361f3d2268a0b89' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1bb225f62190aebd9d00b5ac0361f3d2268a0b89[a-z0-9]*/${root}\/\2/g" "${file}"
done
