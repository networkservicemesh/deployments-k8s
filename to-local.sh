...
grep '?ref=6aa62a08789559e1fb9735ea9dc28f1ad5d07ee4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6aa62a08789559e1fb9735ea9dc28f1ad5d07ee4/${root}\/\2/g" "${file}"
done
