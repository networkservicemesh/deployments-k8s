...
grep '?ref=69619decada1797a5985381f527a08203eb583ca' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=69619decada1797a5985381f527a08203eb583ca/${root}\/\2/g" "${file}"
done
