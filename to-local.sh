...
grep 'ref=d8294632aa268af80c69e7937bd91f14c3585d8a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d8294632aa268af80c69e7937bd91f14c3585d8a[a-z0-9]*/${root}\/\2/g" "${file}"
done
