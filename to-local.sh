...
grep '?ref=c57b1f61ff4fe99f8f5d65b812855ab677d3ba42' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c57b1f61ff4fe99f8f5d65b812855ab677d3ba42/${root}\/\2/g" "${file}"
done
