...
grep 'ref=ce323a8e470e6c37600e006d38a3290e7ab521f8' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ce323a8e470e6c37600e006d38a3290e7ab521f8[a-z0-9]*/${root}\/\2/g" "${file}"
done
