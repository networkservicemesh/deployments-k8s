...
grep '?ref=a0958ce14e46273bce5e9f5fd74289ea8be80560' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a0958ce14e46273bce5e9f5fd74289ea8be80560/${root}\/\2/g" "${file}"
done
