...
grep 'ref=6c3ffe04d7c45ef98e2474f0d4a136f6ce6b35d3' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6c3ffe04d7c45ef98e2474f0d4a136f6ce6b35d3[a-z0-9]*/${root}\/\2/g" "${file}"
done
