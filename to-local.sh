...
grep 'ref=3997839e6c4156d43c4123e26f665a19bb9e7e91' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3997839e6c4156d43c4123e26f665a19bb9e7e91[a-z0-9]*/${root}\/\2/g" "${file}"
done
