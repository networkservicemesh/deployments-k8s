...
grep 'ref=2d8bd751d309b6d8338c9ecb6ce2f195c0bab7f6' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2d8bd751d309b6d8338c9ecb6ce2f195c0bab7f6[a-z0-9]*/${root}\/\2/g" "${file}"
done
