...
grep 'ref=144bd0b910e359bd074ceb64749d11f264d4d6b5' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=144bd0b910e359bd074ceb64749d11f264d4d6b5[a-z0-9]*/${root}\/\2/g" "${file}"
done
