...
grep 'ref=bed42e42bc429dabcb4b3a3be6a1a4095f330204' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=bed42e42bc429dabcb4b3a3be6a1a4095f330204[a-z0-9]*/${root}\/\2/g" "${file}"
done
