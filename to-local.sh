...
grep '?ref=a9bcfae05cce0041ca301901f92e68b921aedb1b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a9bcfae05cce0041ca301901f92e68b921aedb1b/${root}\/\2/g" "${file}"
done
