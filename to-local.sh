...
grep 'ref=0aba399d3ef0b248f177ef84996202e804b2c604' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=0aba399d3ef0b248f177ef84996202e804b2c604[a-z0-9]*/${root}\/\2/g" "${file}"
done
