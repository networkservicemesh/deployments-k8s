...
grep 'ref=3a4229ab783e0f97d76ebade03a2c4771a96db42' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3a4229ab783e0f97d76ebade03a2c4771a96db42[a-z0-9]*/${root}\/\2/g" "${file}"
done
