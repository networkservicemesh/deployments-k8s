...
grep '?ref=3da84ac19286d79d2965ef9338681ccc0dcaf66e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3da84ac19286d79d2965ef9338681ccc0dcaf66e/${root}\/\2/g" "${file}"
done
