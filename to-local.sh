...
grep '?ref=103a65bff10a18d8b74e20e565ac9a9cabda91a7' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=103a65bff10a18d8b74e20e565ac9a9cabda91a7/${root}\/\2/g" "${file}"
done
