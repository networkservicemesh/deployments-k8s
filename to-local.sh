...
grep 'ref=d2e87a0bb1ea5340c63f3c992206bf110833fa53' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d2e87a0bb1ea5340c63f3c992206bf110833fa53[a-z0-9]*/${root}\/\2/g" "${file}"
done
