...
grep 'ref=c09e08daf3a0b85672d4dc4f2a43d1604459c3f7' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c09e08daf3a0b85672d4dc4f2a43d1604459c3f7[a-z0-9]*/${root}\/\2/g" "${file}"
done
