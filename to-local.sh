...
grep 'ref=19cf6b23bbb23c0976f41036fe557a3fd16debb1' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=19cf6b23bbb23c0976f41036fe557a3fd16debb1[a-z0-9]*/${root}\/\2/g" "${file}"
done
