...
grep 'ref=0cd4796e6b44beeb6324e16c0cb073c0e82fc777' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=0cd4796e6b44beeb6324e16c0cb073c0e82fc777[a-z0-9]*/${root}\/\2/g" "${file}"
done
