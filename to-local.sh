...
grep '?ref=f35a46637f17f7addbb3fa20e5e676f770088ab1' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f35a46637f17f7addbb3fa20e5e676f770088ab1/${root}\/\2/g" "${file}"
done
