...
grep '?ref=14fd0cdff38126bbc7ae7dcbfbf03450645cc2f2' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=14fd0cdff38126bbc7ae7dcbfbf03450645cc2f2/${root}\/\2/g" "${file}"
done
