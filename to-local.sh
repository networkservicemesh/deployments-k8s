...
grep 'ref=d597bd25a4242bdec7469db3caecf45027a24f62' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d597bd25a4242bdec7469db3caecf45027a24f62[a-z0-9]*/${root}\/\2/g" "${file}"
done
