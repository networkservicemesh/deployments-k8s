...
grep '?ref=59c5f14ba4d6e9aeb87ae7aa040c04b82eebfb2b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=59c5f14ba4d6e9aeb87ae7aa040c04b82eebfb2b/${root}\/\2/g" "${file}"
done
