...
grep '?ref=13b0aa4a97859e28980385e11b47aba8dd6ed0cf' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=13b0aa4a97859e28980385e11b47aba8dd6ed0cf/${root}\/\2/g" "${file}"
done
