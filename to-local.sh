...
grep 'ref=329ad9886ab40242ead2490b238a96a6380cb67a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=329ad9886ab40242ead2490b238a96a6380cb67a[a-z0-9]*/${root}\/\2/g" "${file}"
done
