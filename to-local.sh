...
grep 'ref=6f9d8954bd0a4ac82fb06c3200f8e56789e3444e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6f9d8954bd0a4ac82fb06c3200f8e56789e3444e[a-z0-9]*/${root}\/\2/g" "${file}"
done
