...
grep 'ref=8e6f7f0f66e24337ea26298f70c1b7c114ea65ae' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=8e6f7f0f66e24337ea26298f70c1b7c114ea65ae[a-z0-9]*/${root}\/\2/g" "${file}"
done
