...
grep 'ref=2360d77af1e997ca0cef26d7d1069b14178cafd0' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2360d77af1e997ca0cef26d7d1069b14178cafd0[a-z0-9]*/${root}\/\2/g" "${file}"
done
