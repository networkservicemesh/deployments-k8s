...
grep 'ref=4b804fb7e56fcc9848f938026d6c379d0de04080' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=4b804fb7e56fcc9848f938026d6c379d0de04080[a-z0-9]*/${root}\/\2/g" "${file}"
done
