...
grep 'ref=442e3f4329c08dd5f92cfde0240bdc780fd9cb18' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=442e3f4329c08dd5f92cfde0240bdc780fd9cb18[a-z0-9]*/${root}\/\2/g" "${file}"
done
