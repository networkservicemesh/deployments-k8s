...
grep 'ref=d3d219731be82f4b5c23043f4ec8da55c1fbde44' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d3d219731be82f4b5c23043f4ec8da55c1fbde44[a-z0-9]*/${root}\/\2/g" "${file}"
done
