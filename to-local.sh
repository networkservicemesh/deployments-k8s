...
grep '?ref=af6ecbeb1ec8fcc76134dc41d3ed9a650432276c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=af6ecbeb1ec8fcc76134dc41d3ed9a650432276c/${root}\/\2/g" "${file}"
done
