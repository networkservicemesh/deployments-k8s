...
grep 'ref=fdc6f30ba6c85e80ca69f8e81036d4f365cb9410' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=fdc6f30ba6c85e80ca69f8e81036d4f365cb9410[a-z0-9]*/${root}\/\2/g" "${file}"
done
