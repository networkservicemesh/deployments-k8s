...
grep 'ref=323b6f8249e92dcab90b81f73f314de7c51ebe04' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=323b6f8249e92dcab90b81f73f314de7c51ebe04[a-z0-9]*/${root}\/\2/g" "${file}"
done
