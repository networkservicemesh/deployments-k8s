...
grep 'ref=3808584bfc502adfdb230a572eb3334de1a1ce08' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3808584bfc502adfdb230a572eb3334de1a1ce08[a-z0-9]*/${root}\/\2/g" "${file}"
done
