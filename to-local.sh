...
grep '?ref=e2e08a5b291d63eff3cd39dcf252c3933d2780df' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e2e08a5b291d63eff3cd39dcf252c3933d2780df/${root}\/\2/g" "${file}"
done
