...
grep 'ref=a574168325036c268160ad49c94572d6183f9fc0' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a574168325036c268160ad49c94572d6183f9fc0[a-z0-9]*/${root}\/\2/g" "${file}"
done
