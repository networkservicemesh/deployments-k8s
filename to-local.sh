...
grep 'ref=1392b9b90d5310a8940fb6a0f9f5dd4475751aa8' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1392b9b90d5310a8940fb6a0f9f5dd4475751aa8[a-z0-9]*/${root}\/\2/g" "${file}"
done
