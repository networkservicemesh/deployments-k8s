...
grep 'ref=68854a3ba2e987a4952bf23d7ec076bb6448b470' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=68854a3ba2e987a4952bf23d7ec076bb6448b470[a-z0-9]*/${root}\/\2/g" "${file}"
done
