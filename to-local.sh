...
grep 'ref=67fc8316f355312ac39900f86a8d67c07513faa1' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=67fc8316f355312ac39900f86a8d67c07513faa1[a-z0-9]*/${root}\/\2/g" "${file}"
done
