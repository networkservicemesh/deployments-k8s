...
grep 'ref=cbafe12ee00a2304d931c9620dd4e64557d2bd8c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=cbafe12ee00a2304d931c9620dd4e64557d2bd8c[a-z0-9]*/${root}\/\2/g" "${file}"
done
