...
grep 'ref=908ba947e81356aa2161b3faaf2088957204c51b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=908ba947e81356aa2161b3faaf2088957204c51b[a-z0-9]*/${root}\/\2/g" "${file}"
done
