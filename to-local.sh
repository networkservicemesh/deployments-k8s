...
grep '?ref=285cb0fbab9ecd47a8c2df7149a3b95b0f1cce01' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=285cb0fbab9ecd47a8c2df7149a3b95b0f1cce01/${root}\/\2/g" "${file}"
done
