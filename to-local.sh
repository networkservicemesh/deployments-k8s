...
grep '?ref=482149aebf0e190a4d90743b5f8ad2710da2bc62' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=482149aebf0e190a4d90743b5f8ad2710da2bc62/${root}\/\2/g" "${file}"
done
