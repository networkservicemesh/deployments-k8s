...
grep 'ref=e1296b681a9da5331fe3011acfbae2ceac3bd420' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e1296b681a9da5331fe3011acfbae2ceac3bd420[a-z0-9]*/${root}\/\2/g" "${file}"
done
