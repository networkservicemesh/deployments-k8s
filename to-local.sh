...
grep 'ref=e7715ed2faaeffcfed2c5acef39dbdbadd7a0c6d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e7715ed2faaeffcfed2c5acef39dbdbadd7a0c6d[a-z0-9]*/${root}\/\2/g" "${file}"
done
