...
grep 'ref=9ef72c46c675de4d0935dc473ab3f8df175e99b0' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9ef72c46c675de4d0935dc473ab3f8df175e99b0[a-z0-9]*/${root}\/\2/g" "${file}"
done
