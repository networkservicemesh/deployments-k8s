...
grep 'ref=99ca10d98a0d2b3593d2731ba3bd2f271d2511ce' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=99ca10d98a0d2b3593d2731ba3bd2f271d2511ce[a-z0-9]*/${root}\/\2/g" "${file}"
done
