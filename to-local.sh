...
grep 'ref=ab7b736b0134acc6ad2bd6e619f280f08a7e0c3d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=ab7b736b0134acc6ad2bd6e619f280f08a7e0c3d[a-z0-9]*/${root}\/\2/g" "${file}"
done
