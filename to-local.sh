...
grep 'ref=88878cca5eb4dfb88ad5ba09f7fc062594437ba9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=88878cca5eb4dfb88ad5ba09f7fc062594437ba9[a-z0-9]*/${root}\/\2/g" "${file}"
done
