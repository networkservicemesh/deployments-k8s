...
grep 'ref=124bccbb2898a292146dc3b622d90dc4c6ede4ec' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=124bccbb2898a292146dc3b622d90dc4c6ede4ec[a-z0-9]*/${root}\/\2/g" "${file}"
done
