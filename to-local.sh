...
grep 'ref=dd217d0df8fdb5c68b47343a1a6a5fddf428499c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=dd217d0df8fdb5c68b47343a1a6a5fddf428499c[a-z0-9]*/${root}\/\2/g" "${file}"
done
