...
grep 'ref=0b584c9a1118e485bcfd4277768bf94267f3cba8' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=0b584c9a1118e485bcfd4277768bf94267f3cba8[a-z0-9]*/${root}\/\2/g" "${file}"
done
