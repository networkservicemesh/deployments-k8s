...
grep 'ref=3b81dd20c7f6013ef4e8cc348f41f3421a71a8cc' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3b81dd20c7f6013ef4e8cc348f41f3421a71a8cc[a-z0-9]*/${root}\/\2/g" "${file}"
done
