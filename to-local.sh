...
grep 'ref=fff4b766f893c6992bcfb8c53e38eed024f4125c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=fff4b766f893c6992bcfb8c53e38eed024f4125c[a-z0-9]*/${root}\/\2/g" "${file}"
done
