...
grep 'ref=97bbd7fc6900dc736d558cb3dc11e6033d913768' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=97bbd7fc6900dc736d558cb3dc11e6033d913768[a-z0-9]*/${root}\/\2/g" "${file}"
done
