...
grep 'ref=69afbbc17284fff9c0eb9b0454cabeb48a8b672b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=69afbbc17284fff9c0eb9b0454cabeb48a8b672b[a-z0-9]*/${root}\/\2/g" "${file}"
done
