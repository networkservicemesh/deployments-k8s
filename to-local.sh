...
grep 'ref=324d39240b1ad4aecf8a6cef427cc938ef9ddaa9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=324d39240b1ad4aecf8a6cef427cc938ef9ddaa9[a-z0-9]*/${root}\/\2/g" "${file}"
done
