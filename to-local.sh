...
grep '?ref=bdbc426a0e1665e385cb3e59ca222cd52d156dc4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=bdbc426a0e1665e385cb3e59ca222cd52d156dc4/${root}\/\2/g" "${file}"
done
