...
grep 'ref=723dd7630dc218a2c35429942ce315e41d2c94b3' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=723dd7630dc218a2c35429942ce315e41d2c94b3[a-z0-9]*/${root}\/\2/g" "${file}"
done
