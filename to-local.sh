...
grep 'ref=8c1b72a498abb60f3fed6c4983b36255073c9d40' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=8c1b72a498abb60f3fed6c4983b36255073c9d40[a-z0-9]*/${root}\/\2/g" "${file}"
done
