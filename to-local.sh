...
grep 'ref=562ba7f2d86aa08734784f6bf2c8edced8791be0' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=562ba7f2d86aa08734784f6bf2c8edced8791be0[a-z0-9]*/${root}\/\2/g" "${file}"
done
