...
grep 'ref=15740cf7204b8c1b7b52f68ed43894c6f10e26ae' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=15740cf7204b8c1b7b52f68ed43894c6f10e26ae[a-z0-9]*/${root}\/\2/g" "${file}"
done
