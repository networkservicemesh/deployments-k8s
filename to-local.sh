...
grep 'ref=223e8efcc99d1ed000399fe5ced511c8101bad8b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=223e8efcc99d1ed000399fe5ced511c8101bad8b[a-z0-9]*/${root}\/\2/g" "${file}"
done
