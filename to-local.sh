...
grep 'ref=1bc4ec33cab9e41643f7809f879b38a991ad0375' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1bc4ec33cab9e41643f7809f879b38a991ad0375[a-z0-9]*/${root}\/\2/g" "${file}"
done
