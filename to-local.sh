...
grep 'ref=f5170d2c21ead19e6a783f74ac74f0b586a3d731' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f5170d2c21ead19e6a783f74ac74f0b586a3d731[a-z0-9]*/${root}\/\2/g" "${file}"
done
