...
grep 'ref=2ade545eae3cc7ba728e6bfd40e56087a367c388' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2ade545eae3cc7ba728e6bfd40e56087a367c388[a-z0-9]*/${root}\/\2/g" "${file}"
done
