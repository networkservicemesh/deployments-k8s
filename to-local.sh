...
grep 'ref=5a81ffcb0605e4db19d45b078ea835298deadcd5' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=5a81ffcb0605e4db19d45b078ea835298deadcd5[a-z0-9]*/${root}\/\2/g" "${file}"
done
