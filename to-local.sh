...
grep '?ref=fa8395dbc6e2ddbbd34b450f11dca2699f660acf' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=fa8395dbc6e2ddbbd34b450f11dca2699f660acf/${root}\/\2/g" "${file}"
done
