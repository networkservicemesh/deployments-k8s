...
grep '?ref=73718fc42ba2fc122c985fe40f5aaf76647d0c91' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=73718fc42ba2fc122c985fe40f5aaf76647d0c91/${root}\/\2/g" "${file}"
done
