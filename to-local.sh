...
grep 'ref=3cce2090115dc567788921d8055fd3d832952677' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3cce2090115dc567788921d8055fd3d832952677[a-z0-9]*/${root}\/\2/g" "${file}"
done
