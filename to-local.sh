...
grep 'ref=a304cd4886d8c140dbc722eb649d6a1d000e9d89' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a304cd4886d8c140dbc722eb649d6a1d000e9d89[a-z0-9]*/${root}\/\2/g" "${file}"
done
