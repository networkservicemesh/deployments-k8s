...
grep 'ref=9ff48eee46a2ea357449637cc33fc517485bc26b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9ff48eee46a2ea357449637cc33fc517485bc26b[a-z0-9]*/${root}\/\2/g" "${file}"
done
