...
grep 'ref=975e85ace844f31824cca4f1fbbab82d0a302140' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=975e85ace844f31824cca4f1fbbab82d0a302140[a-z0-9]*/${root}\/\2/g" "${file}"
done
