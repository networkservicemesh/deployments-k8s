...
grep 'ref=7af690ead73894d6a0bb3d26d1681c92cf9ed855' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7af690ead73894d6a0bb3d26d1681c92cf9ed855[a-z0-9]*/${root}\/\2/g" "${file}"
done
