...
grep 'ref=9c5159983e68cd6c08ff809250cd1424da2185f9' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9c5159983e68cd6c08ff809250cd1424da2185f9[a-z0-9]*/${root}\/\2/g" "${file}"
done
