...
grep '?ref=f2c1afe89d5bdea3c02873b089ccfca2c370ec8d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f2c1afe89d5bdea3c02873b089ccfca2c370ec8d/${root}\/\2/g" "${file}"
done
