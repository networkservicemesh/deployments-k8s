...
grep 'ref=2ae3974fc858ac8635b38ab7d517cb56cab4b22e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2ae3974fc858ac8635b38ab7d517cb56cab4b22e[a-z0-9]*/${root}\/\2/g" "${file}"
done
