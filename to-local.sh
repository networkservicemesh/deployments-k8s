...
grep 'ref=6da48eca15f7a0d3644d4bec3b09b64f94209119' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6da48eca15f7a0d3644d4bec3b09b64f94209119[a-z0-9]*/${root}\/\2/g" "${file}"
done
