...
grep '?ref=a2c7c850f432fd70e320b7c50f58f00a63f6c6c2' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=a2c7c850f432fd70e320b7c50f58f00a63f6c6c2/${root}\/\2/g" "${file}"
done
