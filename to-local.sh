...
grep 'ref=90b433462fff3bf5fa8b011b0ca0365bf09ea6bc' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=90b433462fff3bf5fa8b011b0ca0365bf09ea6bc[a-z0-9]*/${root}\/\2/g" "${file}"
done
