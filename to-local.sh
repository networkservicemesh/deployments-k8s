...
grep 'ref=e4d1c927abadb8e5e4ae01f1b31b700f68d3f17e' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e4d1c927abadb8e5e4ae01f1b31b700f68d3f17e[a-z0-9]*/${root}\/\2/g" "${file}"
done
