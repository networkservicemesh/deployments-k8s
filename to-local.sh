...
grep 'ref=7ff7f658266f782814fa9f68a45f5b5d5738efdf' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7ff7f658266f782814fa9f68a45f5b5d5738efdf[a-z0-9]*/${root}\/\2/g" "${file}"
done
