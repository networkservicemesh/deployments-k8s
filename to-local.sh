...
grep 'ref=671dc4ba167aa070bac36e16e563ba28c45e0696' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=671dc4ba167aa070bac36e16e563ba28c45e0696[a-z0-9]*/${root}\/\2/g" "${file}"
done
