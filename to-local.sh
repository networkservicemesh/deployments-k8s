...
grep 'ref=9e560dc1bbe0488f124d1e36212ab49d45fedc4d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9e560dc1bbe0488f124d1e36212ab49d45fedc4d[a-z0-9]*/${root}\/\2/g" "${file}"
done
