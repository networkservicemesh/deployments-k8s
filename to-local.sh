...
grep 'ref=b87e31de7a973d78106f85e31c1ca0acf60dc284' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=b87e31de7a973d78106f85e31c1ca0acf60dc284[a-z0-9]*/${root}\/\2/g" "${file}"
done
