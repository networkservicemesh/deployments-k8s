...
grep 'ref=bf24fd64f9164d3b019a9430b6d5bbd7a3a0c896' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=bf24fd64f9164d3b019a9430b6d5bbd7a3a0c896[a-z0-9]*/${root}\/\2/g" "${file}"
done
