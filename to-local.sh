...
grep 'ref=348c03bc3e7ecfb64ceca177750c36bec84ebd9c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=348c03bc3e7ecfb64ceca177750c36bec84ebd9c[a-z0-9]*/${root}\/\2/g" "${file}"
done
