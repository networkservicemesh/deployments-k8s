...
grep 'ref=7207a42044c4636ba6701e5f86084eb68aa4af4f' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=7207a42044c4636ba6701e5f86084eb68aa4af4f[a-z0-9]*/${root}\/\2/g" "${file}"
done
