...
grep 'ref=73d5a33d48c736ab7580352331c8c79b2b8ab7e3' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=73d5a33d48c736ab7580352331c8c79b2b8ab7e3[a-z0-9]*/${root}\/\2/g" "${file}"
done
