...
grep 'ref=1f04ef3bb9fd7d0ae6de56fc5f16bd753d9db096' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1f04ef3bb9fd7d0ae6de56fc5f16bd753d9db096[a-z0-9]*/${root}\/\2/g" "${file}"
done
