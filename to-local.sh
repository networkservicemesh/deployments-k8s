...
grep 'ref=9633e84ce7c2b0c628a662eb550b889ebc7cc1e8' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9633e84ce7c2b0c628a662eb550b889ebc7cc1e8[a-z0-9]*/${root}\/\2/g" "${file}"
done
