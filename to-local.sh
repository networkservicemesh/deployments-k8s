...
grep 'ref=86b9ca2d05dbad2b626bcabc6258e63b8722b140' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=86b9ca2d05dbad2b626bcabc6258e63b8722b140[a-z0-9]*/${root}\/\2/g" "${file}"
done
