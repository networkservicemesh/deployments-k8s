...
grep 'ref=2530fd5457574caa0e5590e79400ccafdbf0f3e6' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=2530fd5457574caa0e5590e79400ccafdbf0f3e6[a-z0-9]*/${root}\/\2/g" "${file}"
done
