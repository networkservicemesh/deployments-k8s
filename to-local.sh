...
grep '?ref=170cc17149054a1bbca91f6e8c2d08d6b797e525' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=170cc17149054a1bbca91f6e8c2d08d6b797e525/${root}\/\2/g" "${file}"
done
