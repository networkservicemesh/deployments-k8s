...
grep '?ref=9d4ab6bdd68fdcf7ea82e77ddda4a03109248ffc' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9d4ab6bdd68fdcf7ea82e77ddda4a03109248ffc/${root}\/\2/g" "${file}"
done
