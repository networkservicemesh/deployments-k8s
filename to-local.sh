...
grep 'ref=1dab0bbf432dff6f1acaa938bbcb72ae12521d7c' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=1dab0bbf432dff6f1acaa938bbcb72ae12521d7c[a-z0-9]*/${root}\/\2/g" "${file}"
done
