...
grep '?ref=dcf954acb6f351a82aa3408c44864a902fa501e4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=dcf954acb6f351a82aa3408c44864a902fa501e4/${root}\/\2/g" "${file}"
done
