...
grep 'ref=c1832bad1e01a394e26c802b584c5645cbbc170a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c1832bad1e01a394e26c802b584c5645cbbc170a[a-z0-9]*/${root}\/\2/g" "${file}"
done
