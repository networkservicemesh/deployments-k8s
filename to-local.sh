...
grep 'ref=8023bfa08410127b09d04667cb95d6f213a93aff' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=8023bfa08410127b09d04667cb95d6f213a93aff[a-z0-9]*/${root}\/\2/g" "${file}"
done
