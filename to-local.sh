...
grep 'ref=c5748eb658f65dc342841cadb51d7981b12215f1' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=c5748eb658f65dc342841cadb51d7981b12215f1[a-z0-9]*/${root}\/\2/g" "${file}"
done
