...
grep '?ref=e770c43af478ea8104fdd5b679189759e5c96ef5' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e770c43af478ea8104fdd5b679189759e5c96ef5/${root}\/\2/g" "${file}"
done
