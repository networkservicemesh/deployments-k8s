...
grep 'ref=4f71fa49501b6b5b5a63506747d2bef7c1a90b37' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=4f71fa49501b6b5b5a63506747d2bef7c1a90b37[a-z0-9]*/${root}\/\2/g" "${file}"
done
