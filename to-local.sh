...
grep '?ref=6ca147a2b26dfad3667f5da28b7d4991b4f6c4ba' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=6ca147a2b26dfad3667f5da28b7d4991b4f6c4ba/${root}\/\2/g" "${file}"
done
