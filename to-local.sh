...
grep '?ref=653902d4cedb12761f019055bb0d9d28db9c5f7f' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=653902d4cedb12761f019055bb0d9d28db9c5f7f/${root}\/\2/g" "${file}"
done
