...
grep 'ref=147302836d55f25c880d2f792d1e46b0d486b3dd' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=147302836d55f25c880d2f792d1e46b0d486b3dd[a-z0-9]*/${root}\/\2/g" "${file}"
done
