...
grep 'ref=3b620cb8fd028d10ca06ebbcc8ec51c49d339a0d' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3b620cb8fd028d10ca06ebbcc8ec51c49d339a0d[a-z0-9]*/${root}\/\2/g" "${file}"
done
