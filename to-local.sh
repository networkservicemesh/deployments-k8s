...
grep 'ref=4ad381d1b154dfbdbdf698ce35456b5deafb84d4' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=4ad381d1b154dfbdbdf698ce35456b5deafb84d4[a-z0-9]*/${root}\/\2/g" "${file}"
done
