...
grep 'ref=45d733c065a9228edb967e65e1ba528da98fc45f' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=45d733c065a9228edb967e65e1ba528da98fc45f[a-z0-9]*/${root}\/\2/g" "${file}"
done
