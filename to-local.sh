...
grep 'ref=888efbf7f144d5dcca245e30db82f12d8d76ab5b' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=888efbf7f144d5dcca245e30db82f12d8d76ab5b[a-z0-9]*/${root}\/\2/g" "${file}"
done
