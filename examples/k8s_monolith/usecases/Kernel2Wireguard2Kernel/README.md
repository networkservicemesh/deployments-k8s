...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/v1.4.0-rc.1/examples/k8s_monolith/usecases/namespace.yaml)[0])
