...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/15f099d61caf9f8b0cecd70205d60b6bfb995134/examples/k8s_monolith/usecases/namespace.yaml)[0])
