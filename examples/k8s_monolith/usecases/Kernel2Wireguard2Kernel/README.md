...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/d0a998384eb7511de067ef517146b599cb8dcbd1/examples/k8s_monolith/usecases/namespace.yaml)[0])
