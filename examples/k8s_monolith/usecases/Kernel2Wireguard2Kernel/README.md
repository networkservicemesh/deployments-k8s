...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/bec886a5f97209a44560ae01765afcadcdfdd160/examples/k8s_monolith/usecases/namespace.yaml)[0])
