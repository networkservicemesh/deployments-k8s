...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/k8s_monolith/configuration/spire?ref=ff1ff4a60c2088e098143838b37300a584d2bf92
```
