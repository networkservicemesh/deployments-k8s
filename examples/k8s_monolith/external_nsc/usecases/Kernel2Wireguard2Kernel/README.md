...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9bfdd080311d7cecb9cf21e5c4c5bcc3df115f08/examples/k8s_monolith/external_nsc/usecases/namespace.yaml)[0])
