...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/v1.5.0-rc.2/examples/k8s_monolith/external_nsc/usecases/namespace.yaml)[0])
