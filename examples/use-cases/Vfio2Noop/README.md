...
bases:
- https://github.com/networkservicemesh/deployments-k8s/apps/nsc-vfio?ref=v1.2.0
- https://github.com/networkservicemesh/deployments-k8s/apps/nse-vfio?ref=v1.2.0
EOF
```
