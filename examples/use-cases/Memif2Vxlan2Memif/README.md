...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/35ffecc5f0bdb88f80bbce0a4423cf2ab9369540/examples/use-cases/namespace.yaml)[0])
...
bases:
- github.com/networkservicemesh/deployments-k8s/apps/nsc-memif?ref=35ffecc5f0bdb88f80bbce0a4423cf2ab9369540
- github.com/networkservicemesh/deployments-k8s/apps/nse-memif?ref=35ffecc5f0bdb88f80bbce0a4423cf2ab9369540
