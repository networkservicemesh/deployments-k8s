...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/v1.1.1/examples/use-cases/namespace.yaml)[0])
...
bases:
- https://github.com/networkservicemesh/deployments-k8s/apps/nsc-memif?ref=v1.1.1-rc.2
- https://github.com/networkservicemesh/deployments-k8s/apps/nse-memif?ref=v1.1.1-rc.2
