...
namespace: ns-kernel2vxlan2memif

resources: 
- client.yaml
- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/eb53399861d97d0b47997c43b62e04f58cd9f94d/examples/use-cases/Kernel2Vxlan2Memif/netsvc.yaml
...
metadata:
  ...
  labels:
    app: alpine    
  annotations:
    networkservicemesh.io: kernel://kernel2vxlan2memif/nsm-1
spec:
  containers:
  - name: alpine
    image: alpine:3.15.0
