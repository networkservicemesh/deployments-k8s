...
>>>>>>>946696acae (refactor all basic suite examples)
```
...
resources: 
- https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Memif2Vxlan2Kernel?ref=3d1dcfe1de90681213c7f0006f25279bb4699966
        ...
        - name: nsc
          env:
            - name: NSM_NETWORK_SERVICES
              value: memif://memif2vxlan2kernel/nsm-1
      nodeName: ${NODES[0]}
EOF
