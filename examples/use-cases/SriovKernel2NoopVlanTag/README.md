...
Deploy ponger:
```bash
kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag/ponger
```
...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag
```
