...
metadata:
  ...
  labels:
    app: alpine    
  annotations:
    networkservicemesh.io: kernel://kernel2memif/nsm-1
spec:
  containers:
  - name: alpine
    image: alpine:3.15.0
...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2Memif?ref=eb53399861d97d0b47997c43b62e04f58cd9f94d
```
