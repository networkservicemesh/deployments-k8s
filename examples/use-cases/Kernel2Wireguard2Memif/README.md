...
resources: 
- client.yaml
- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/946696acae3156e3e72bdb42cdda5147725fd0a2/examples/use-cases/Kernel2Wireguard2Memif/netsvc.yaml
...
metadata:
  ...
  labels:
    app: alpine    
  annotations:
    networkservicemesh.io: kernel://kernel2wireguard2memif/nsm-1
spec:
  containers:
  - name: alpine
    image: alpine:3.15.0
