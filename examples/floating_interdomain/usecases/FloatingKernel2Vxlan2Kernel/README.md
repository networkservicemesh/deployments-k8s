...
Deploy NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/floating_interdomain/usecases/FloatingKernel2Vxlan2Kernel/cluster2?ref=88fa4d08aca35783d6aab60f1bf0233d2d01130a
```
...
Deploy NSC:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/floating_interdomain/usecases/FloatingKernel2Vxlan2Kernel/cluster1?ref=88fa4d08aca35783d6aab60f1bf0233d2d01130a
```
