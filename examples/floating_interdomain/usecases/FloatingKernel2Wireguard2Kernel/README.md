...
Deploy NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/floating_interdomain/usecases/FloatingKernel2Wireguard2Kernel/cluster2?ref=2b4374aec83267373830d4ad69e7b9a661b51810
```
...
Deploy NSC:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/floating_interdomain/usecases/FloatingKernel2Wireguard2Kernel/cluster1?ref=2b4374aec83267373830d4ad69e7b9a661b51810
```
