...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=dcfb0cd81ce3df9316cce2e251f8cf94ed884653
```

```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/dcfb0cd81ce3df9316cce2e251f8cf94ed884653/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/dcfb0cd81ce3df9316cce2e251f8cf94ed884653/examples/features/change-nse-dynamically/green-netsvc.yaml
```
