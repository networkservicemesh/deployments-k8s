...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=e2879b550def978da25af63e9e84de3b81fa9647
```

```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e2879b550def978da25af63e9e84de3b81fa9647/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e2879b550def978da25af63e9e84de3b81fa9647/examples/features/change-nse-dynamically/green-netsvc.yaml
```
