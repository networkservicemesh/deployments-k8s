...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=a6faba2a2401149accdb538abe47a188068f677a
```

```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/a6faba2a2401149accdb538abe47a188068f677a/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/a6faba2a2401149accdb538abe47a188068f677a/examples/features/change-nse-dynamically/green-netsvc.yaml
```
