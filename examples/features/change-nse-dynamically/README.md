...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=4b76a8d3697a2058ef356b9c617cada56b163a73
```

```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/4b76a8d3697a2058ef356b9c617cada56b163a73/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/4b76a8d3697a2058ef356b9c617cada56b163a73/examples/features/change-nse-dynamically/green-netsvc.yaml
```
