...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=4ed3a3f1b4e5ed4889cbe394a79a571df70c9010
```

```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/4ed3a3f1b4e5ed4889cbe394a79a571df70c9010/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/4ed3a3f1b4e5ed4889cbe394a79a571df70c9010/examples/features/change-nse-dynamically/green-netsvc.yaml
```
