...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=ab7e5a24ef93ee07a85e36c523a30d9bd5bad50c
```

```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ab7e5a24ef93ee07a85e36c523a30d9bd5bad50c/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ab7e5a24ef93ee07a85e36c523a30d9bd5bad50c/examples/features/change-nse-dynamically/green-netsvc.yaml
```
