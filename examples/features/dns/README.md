...
resources:
- dnsutils.yaml
- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/57c9003b1048888a88cd734cfd769f0cd22c7011/examples/features/dns/coredns-config-map.yaml
