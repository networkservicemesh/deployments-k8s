...
resources:
- dnsutils.yaml
- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/1b4ebff2fd10a1a9316a437183d1e0807494ee81/examples/features/dns/coredns-config-map.yaml
