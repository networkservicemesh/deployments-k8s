...
resources:
- dnsutils.yaml
- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/fbc6ad46f4cf21db6a54c3782a853675902c8790/examples/features/dns/coredns-config-map.yaml
