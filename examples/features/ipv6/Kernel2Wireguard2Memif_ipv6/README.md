...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2Memif_ipv6?ref=90638399350960f52bc2fb3895d7a654fe298ae1
```
