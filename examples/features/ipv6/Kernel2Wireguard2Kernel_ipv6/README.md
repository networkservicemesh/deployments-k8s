...
metadata:
  ...
  labels:
    app: alpine    
  annotations:
    networkservicemesh.io: kernel://kernel2wireguard2kernel-ipv6/nsm-1
spec:
  containers:
  - name: alpine
    image: alpine:3.15.0
        ...
        - name: nse
          env:
            ...
            - name: NSM_SERVICE_NAMES
              value: "kernel2wireguard2kernel-ipv6"
...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/ipv6/Kernel2Wireguard2Kernel_ipv6?ref=562c4f9383ab2a2526008bd7ebace8acf8b18080
```
