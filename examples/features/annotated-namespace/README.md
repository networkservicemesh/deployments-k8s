...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=97c2aaf46df2b0acba7a874547a56ab3fb50ce32
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/97c2aaf46df2b0acba7a874547a56ab3fb50ce32/examples/features/annotated-namespace/client.yaml
```
