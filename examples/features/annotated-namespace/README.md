...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=b890393a621e75eca0202d1e034c9d9b5cf407de
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/b890393a621e75eca0202d1e034c9d9b5cf407de/examples/features/annotated-namespace/client.yaml
```
