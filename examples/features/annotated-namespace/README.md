...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=fa520c4ab2b7c426e445a655e0ca80cbcf50cb77
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/fa520c4ab2b7c426e445a655e0ca80cbcf50cb77/examples/features/annotated-namespace/client.yaml
```
