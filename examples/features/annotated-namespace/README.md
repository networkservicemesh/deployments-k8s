...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=efa709a6043734b62d91b8226f8a5610237e9402
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/efa709a6043734b62d91b8226f8a5610237e9402/examples/features/annotated-namespace/client.yaml
```
