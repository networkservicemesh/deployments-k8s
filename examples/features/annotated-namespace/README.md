...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=4ed3a3f1b4e5ed4889cbe394a79a571df70c9010
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/4ed3a3f1b4e5ed4889cbe394a79a571df70c9010/examples/features/annotated-namespace/client.yaml
```
