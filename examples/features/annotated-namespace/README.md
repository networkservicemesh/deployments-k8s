...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=504e406ac83936e06a86c9dfcdafc9a33a667360
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/504e406ac83936e06a86c9dfcdafc9a33a667360/examples/features/annotated-namespace/client.yaml
```
