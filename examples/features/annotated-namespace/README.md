...
```bash
kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/features/annotated-namespace
```
...
Apply client patch:
```bash
kubectl apply -f ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/features/annotated-namespace/client.yaml
```
