...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=73e8f8bff31a9abe1f14a50f2555adc89e78503d
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/73e8f8bff31a9abe1f14a50f2555adc89e78503d/examples/features/annotated-namespace/client.yaml
```
