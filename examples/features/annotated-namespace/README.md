...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=a3be260b595adffd36c738d62f42804cee13091b
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/a3be260b595adffd36c738d62f42804cee13091b/examples/features/annotated-namespace/client.yaml
```
