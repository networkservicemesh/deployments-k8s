...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=5c3978411d1164402141774bbf81bde4a0b8aa35
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/5c3978411d1164402141774bbf81bde4a0b8aa35/examples/features/annotated-namespace/client.yaml
```
