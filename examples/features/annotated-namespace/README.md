...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=c4abd531f19c4cb394531accb286c69baf400d1f
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/c4abd531f19c4cb394531accb286c69baf400d1f/examples/features/annotated-namespace/client.yaml
```
