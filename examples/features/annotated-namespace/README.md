...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/775179868ffb04c54f356e0049d166c32c57f4b8/examples/features/annotated-namespace/client.yaml
```
