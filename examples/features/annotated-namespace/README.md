...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=60915fbd8f70456d75ba47bf094a703e4a4fef0c
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/60915fbd8f70456d75ba47bf094a703e4a4fef0c/examples/features/annotated-namespace/client.yaml
```
