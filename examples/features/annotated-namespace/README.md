...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=ec4f840985949bd61c2e04a3dd16807a617e199a
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ec4f840985949bd61c2e04a3dd16807a617e199a/examples/features/annotated-namespace/client.yaml
```
