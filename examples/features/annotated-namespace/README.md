...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=bc9d18449c5576cdccb633a827c6852b0d635c11
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/bc9d18449c5576cdccb633a827c6852b0d635c11/examples/features/annotated-namespace/client.yaml
```
