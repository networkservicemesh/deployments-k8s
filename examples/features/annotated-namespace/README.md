...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=52aff529b6f3979cfabbfb8b7d747e996da26819
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/52aff529b6f3979cfabbfb8b7d747e996da26819/examples/features/annotated-namespace/client.yaml
```
