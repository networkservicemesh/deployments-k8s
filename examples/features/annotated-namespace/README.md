...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=aa50a3a5638906359a3fd040475a546fba68835f
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/aa50a3a5638906359a3fd040475a546fba68835f/examples/features/annotated-namespace/client.yaml
```
