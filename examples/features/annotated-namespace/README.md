...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=415ffaf04020a58a04be96a7da03eef6e34b7e96
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/415ffaf04020a58a04be96a7da03eef6e34b7e96/examples/features/annotated-namespace/client.yaml
```
