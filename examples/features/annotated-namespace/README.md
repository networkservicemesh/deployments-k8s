...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=7835a9c69ecd678aa5cbb3fe517908e0b76b9684
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7835a9c69ecd678aa5cbb3fe517908e0b76b9684/examples/features/annotated-namespace/client.yaml
```
