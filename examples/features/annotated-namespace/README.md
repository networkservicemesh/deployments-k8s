...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=afdbb9233c8b77be3eb72fd60a163be4f4025407
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/afdbb9233c8b77be3eb72fd60a163be4f4025407/examples/features/annotated-namespace/client.yaml
```
