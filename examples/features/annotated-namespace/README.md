...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=158289cac35ed8cfbfa2850b0469625690141499
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/158289cac35ed8cfbfa2850b0469625690141499/examples/features/annotated-namespace/client.yaml
```
