...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=be79ca294f12156ae1107467f592b3cda7c7cb42
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/be79ca294f12156ae1107467f592b3cda7c7cb42/examples/features/annotated-namespace/client.yaml
```
