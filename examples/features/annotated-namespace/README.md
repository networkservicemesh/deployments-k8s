...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=56b6cc7a68eefb10e0217b8af9da5cec2a1c595a
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/56b6cc7a68eefb10e0217b8af9da5cec2a1c595a/examples/features/annotated-namespace/client.yaml
```
