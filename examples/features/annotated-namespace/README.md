...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/annotated-namespace?ref=4431d48a75a194b165f309f6051a6f28f93e7c50
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/4431d48a75a194b165f309f6051a6f28f93e7c50/examples/features/annotated-namespace/client.yaml
```
