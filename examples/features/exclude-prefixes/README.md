...
TODO: move it to kustomization file ?
...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/exclude-prefixes?ref=3a344104e4af53f30f0101cdcbbc9b2bc5433463
```
