...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns?ref=eab812a66d841172c48ce27776f9bc1e06afe4ac
```

2. Deploy network service:
```bash
kubectl apply -f https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns/vl3-netsvc.yaml?ref=eab812a66d841172c48ce27776f9bc1e06afe4ac
```
