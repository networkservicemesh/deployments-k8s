...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns?ref=d5b6ac425d974cd3e766815f0b2e000a8a733384
```

2. Deploy network service:
```bash
kubectl apply -f https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns/vl3-netsvc.yaml?ref=d5b6ac425d974cd3e766815f0b2e000a8a733384
```
