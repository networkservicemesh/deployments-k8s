...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/vl3-dns?ref=505fec639b436f5e9093c6611b74636aaf4ed501
```
...
do
    for pinger in $nscs
    do
        kubectl exec $pinger -n ns-vl3-dns -- ping -c4 $nsc.my-vl3-network
    done
done
```
