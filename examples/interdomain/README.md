...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/interdomain?ref=7c1c95e489bfee77696b35d6581eedc25bd91875
```
...
```bash
kubectl apply -k github.com/networkservicemesh/deployments-k8s/apps/registry-k8s?ref=7c1c95e489bfee77696b35d6581eedc25bd91875
```
