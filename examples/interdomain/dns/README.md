...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/2726c97da7333277e72587e4242a0932dbc488de/examples/interdomain/dns/service.yaml
```
