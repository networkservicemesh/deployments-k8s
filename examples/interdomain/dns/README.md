...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/41b0b4756acea45a72f9341e2dce466798c395b6/examples/interdomain/dns/service.yaml
```
