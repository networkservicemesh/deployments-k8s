...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/620b8317903ee40de8eac757ba88be1df1498f36/examples/interdomain/dns/service.yaml
```
