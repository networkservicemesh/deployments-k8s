...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/8628890b635cf154218a2f870387b55c14c67cd2/examples/interdomain/dns/service.yaml
```
