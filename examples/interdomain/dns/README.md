...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/1089cd64cd1c7e415ae7f92013a55bbfdfd8ea55/examples/interdomain/dns/service.yaml
```
