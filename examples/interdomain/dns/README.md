...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/dc575e7cfa955ec8f5928720d594b482cbba8405/examples/interdomain/dns/service.yaml
```
