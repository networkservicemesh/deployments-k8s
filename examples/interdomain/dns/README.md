...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/89c4b60f172d90f8745c19bf6190fdacb3c1c29e/examples/interdomain/dns/service.yaml
```
