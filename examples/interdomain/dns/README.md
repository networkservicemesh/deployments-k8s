...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/cde03bc115e0a4d3a0e3367e4f302a95a0a4af9b/examples/interdomain/dns/service.yaml
```
