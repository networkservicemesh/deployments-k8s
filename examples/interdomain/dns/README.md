...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/8f278e6551429f09bb5dd42176c70724c9ad556d/examples/interdomain/dns/service.yaml
```
