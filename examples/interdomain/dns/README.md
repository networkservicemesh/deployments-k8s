...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/f8d197290e199f651768f61cf9991cd30c2cb4d4/examples/interdomain/dns/service.yaml
```
