...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/798b07d4c35f7cd9092a646af11c1d5008e24245/examples/interdomain/dns/service.yaml
```
