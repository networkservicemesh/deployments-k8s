...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9cef5b64e202fb30898c0c18fe5703ba927f5ff0/examples/interdomain/dns/service.yaml
```
