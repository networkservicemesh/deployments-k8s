...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/5dd55851bf8be5cac1b087f82d4dd7d902e6e544/examples/interdomain/dns/service.yaml
```
