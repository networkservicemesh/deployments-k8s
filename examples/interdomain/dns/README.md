...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/fd80dc669d39d4189cbf796714b97c6235ebce15/examples/interdomain/dns/service.yaml
```
