...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/f35176dadb970942e71dd7de123ffd9dba374798/examples/interdomain/dns/service.yaml
```
