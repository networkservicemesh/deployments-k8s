...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/f39f98bcf35fe07f619efaadd7895d1faaf71268/examples/interdomain/dns/service.yaml
```
