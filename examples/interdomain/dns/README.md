...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/5ee254b650ab1fd45026dcfe2a9c207ea65e9e5a/examples/interdomain/dns/service.yaml
```
