...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/f7419f2dd99c55487043d53b562da76d967f4af3/examples/interdomain/dns/service.yaml
```
