...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/a108a030d2299615abc4a1f5ea3b3ca53ba05568/examples/interdomain/dns/service.yaml
```
