...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/4ad381d1b154dfbdbdf698ce35456b5deafb84d4/examples/interdomain/dns/service.yaml
```
