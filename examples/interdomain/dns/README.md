...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/088dbda982cf4aa1f31c439a7854ddfaddda115a/examples/interdomain/dns/service.yaml
```
