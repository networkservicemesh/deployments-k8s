...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9741814d5a013f0ee0a0f19bbd3afd0399055c2e/examples/interdomain/dns/service.yaml
```
