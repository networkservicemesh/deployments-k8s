...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ee4573babb56821e82f2d85da2f934eb15838b15/examples/interdomain/dns/service.yaml
```
