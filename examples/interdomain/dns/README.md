...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/42dcf42321c38ccce88d1e3dce4d2c94d0b28cad/examples/interdomain/dns/service.yaml
```
