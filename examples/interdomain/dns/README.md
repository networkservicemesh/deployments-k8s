...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/a33780978e4cd9d7d8a6acb45a094136a7df11dc/examples/interdomain/dns/service.yaml
```
