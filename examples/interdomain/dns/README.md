...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/2ca3773b5da0c09d5211f0594df196da4234c22c/examples/interdomain/dns/service.yaml
```
