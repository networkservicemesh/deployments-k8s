...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/228d474f80168d59f06c1dd491adc0a36674aca3/examples/interdomain/dns/service.yaml
```
