...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/42e63fc9842cb8924c82a79cdd53c8dd7f32b977/examples/interdomain/dns/service.yaml
```
