...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7ed0e02a1906410ac7bd158e0c27124f88fc1b2f/examples/interdomain/dns/service.yaml
```
