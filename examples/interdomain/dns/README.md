...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/f51e483c361569efcd41934b403c33220dcf34e4/examples/interdomain/dns/service.yaml
```
