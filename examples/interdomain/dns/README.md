...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/3b620cb8fd028d10ca06ebbcc8ec51c49d339a0d/examples/interdomain/dns/service.yaml
```
