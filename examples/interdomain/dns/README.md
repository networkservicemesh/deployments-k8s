...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/86f8bc52b22299a7c5d1d769ee2bf31125cb8269/examples/interdomain/dns/service.yaml
```
