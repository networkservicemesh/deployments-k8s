...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/d9c59878e264d5347f4609f0f399ecae678dbd16/examples/interdomain/dns/service.yaml
```
