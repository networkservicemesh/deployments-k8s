...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ba12c72e81727b0569219e343a315ffbc58bd902/examples/interdomain/dns/service.yaml
```
