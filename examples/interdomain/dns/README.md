...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/03c7f77fd2ad5b18c670ddcd784878480a032b78/examples/interdomain/dns/service.yaml
```
