...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/384d573ec7cfd25331440d6a6de60924c5caf379/examples/interdomain/dns/service.yaml
```
