...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/b92b4744a0f9e6a2fc8b4e04b7ea2a8f9a71d086/examples/interdomain/dns/service.yaml
```
