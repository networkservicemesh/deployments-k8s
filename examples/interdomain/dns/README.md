...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/46baafaa949d1905a748661a5f07b2b625396294/examples/interdomain/dns/service.yaml
```
