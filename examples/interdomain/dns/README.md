...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/eba40c35dcaf8cc1091a661029f92a72fa408940/examples/interdomain/dns/service.yaml
```
