...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/a4a258ce4cc11444d41634b703fae9326953570d/examples/interdomain/dns/service.yaml
```
