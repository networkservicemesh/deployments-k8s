...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/a5eae8685bc4a9d3057ab28a36b5f9eec28fdad3/examples/interdomain/dns/service.yaml
```
