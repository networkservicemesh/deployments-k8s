...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/afaef4e195cb06a214bb932cb8fe662e3524d514/examples/interdomain/dns/service.yaml
```
