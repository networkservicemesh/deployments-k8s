...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/7216db136ff7d256e0cf4c88ead7c5dd38cb69b1/examples/interdomain/dns/service.yaml
```
