...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/93e558f32df26b512bab45d3a6241fbdaaa9d78f/examples/interdomain/dns/service.yaml
```
