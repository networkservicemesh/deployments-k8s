...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/36b86447796c9beb08c8d589c861857d04a73a78/examples/interdomain/dns/service.yaml
```
