...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ea6a66412ef4d39498b55bf38cfe2e5ccc23a1cf/examples/interdomain/dns/service.yaml
```
