...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/d4efbe84c0fe293deb34cd48c764a63723ead0b5/examples/interdomain/dns/service.yaml
```
