...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9a92f8611a53e15cca0d83ae28e9d518014c397a/examples/interdomain/dns/service.yaml
```
