...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/5a6cb048fbf3012a51d13a7e42ba019a7cbc1fb4/examples/interdomain/dns/service.yaml
```
