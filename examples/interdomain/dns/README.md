...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/df5522a4430fe0d862e64d8becb7d57520c2ffc0/examples/interdomain/dns/service.yaml
```
