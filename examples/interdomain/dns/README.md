...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/2f8f591df418ae880bdefcbfbb03a1bd705f080b/examples/interdomain/dns/service.yaml
```
