...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/dec450948b354a3af467b4188e074839667c8e60/examples/interdomain/dns/service.yaml
```
