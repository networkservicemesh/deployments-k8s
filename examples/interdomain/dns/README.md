...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/af015ee6b6a060a7054a44079d05f2ef0f49d4e3/examples/interdomain/dns/service.yaml
```
