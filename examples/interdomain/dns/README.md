...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/706e2ae7d1c44fb43093eff4856d9a98712be0b8/examples/interdomain/dns/service.yaml
```
