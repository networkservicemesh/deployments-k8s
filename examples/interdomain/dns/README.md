...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/86d66009bb447b10e6378a7522635cd0f3eac3d5/examples/interdomain/dns/service.yaml
```
