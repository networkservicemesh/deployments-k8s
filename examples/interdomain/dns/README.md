...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/cda36593ed4ae2fcb16e961ae6a6aff04612f53e/examples/interdomain/dns/service.yaml
```
