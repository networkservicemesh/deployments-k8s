...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e9f6e444bd6edd7c1dac07d3ae774c5c3c7fc8df/examples/interdomain/dns/service.yaml
```
