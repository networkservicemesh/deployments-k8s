...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9142a0da594340028464561dcf79f8bff929635e/examples/interdomain/dns/service.yaml
```
