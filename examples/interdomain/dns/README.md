...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/bb3b7ea884f935fc64dddfb5cd1840f3bd01cfc7/examples/interdomain/dns/service.yaml
```
