...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/050a5817cb8104b907e2c241a7af38c08d3102d1/examples/interdomain/dns/service.yaml
```
