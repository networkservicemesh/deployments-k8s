...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanvpp?ref=f348c5ef58f96dac8411ed68c0257d9a777c80f9
```
...
```bash
kubectl delete -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanvpp?ref=f348c5ef58f96dac8411ed68c0257d9a777c80f9
```
