...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanvpp?ref=3acdc9eeea039fdd8fe48e600f41b56e72007bc6
```
...
```bash
kubectl delete -k https://github.com/networkservicemesh/deployments-k8s/examples/remotevlan/rvlanvpp?ref=3acdc9eeea039fdd8fe48e600f41b56e72007bc6
```
