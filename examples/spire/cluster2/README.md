...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster2?ref=6a019669b0ae290e6e741f5ed558515ceff61f18
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/6a019669b0ae290e6e741f5ed558515ceff61f18/examples/spire/cluster2/clusterspiffeid-template.yaml
```
