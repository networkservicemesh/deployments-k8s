...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster2?ref=328b448a5d21b92499c0f090cfb27700d0274077
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/328b448a5d21b92499c0f090cfb27700d0274077/examples/spire/cluster2/clusterspiffeid-template.yaml
```
