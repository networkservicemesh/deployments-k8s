...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster2?ref=eb565813f1926607691b17faeecdbc16436957b6
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/eb565813f1926607691b17faeecdbc16436957b6/examples/spire/cluster2/clusterspiffeid-template.yaml
```
