...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster2?ref=aac0c457c3cfea24a3a40cb4665dd5b1d4b386e3
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/aac0c457c3cfea24a3a40cb4665dd5b1d4b386e3/examples/spire/cluster2/clusterspiffeid-template.yaml
```
