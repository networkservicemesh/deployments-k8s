...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster2?ref=c89071a2c8d866aab956a628b808433ca320e7e3
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/c89071a2c8d866aab956a628b808433ca320e7e3/examples/spire/cluster2/clusterspiffeid-template.yaml
```
