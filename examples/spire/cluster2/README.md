...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster2?ref=70b76fc5c70979e0ff4df3b1d084311084259870
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/70b76fc5c70979e0ff4df3b1d084311084259870/examples/spire/cluster2/clusterspiffeid-template.yaml
```
