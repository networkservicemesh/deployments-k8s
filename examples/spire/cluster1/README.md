...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=99e72637eafb243efedaa6726d9b7f8cc53906e3
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/99e72637eafb243efedaa6726d9b7f8cc53906e3/examples/spire/cluster1/clusterspiffeid-template.yaml
```
