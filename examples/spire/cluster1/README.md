...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=2da029ac1a25c6d2120419d20931a26dc19de417
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/2da029ac1a25c6d2120419d20931a26dc19de417/examples/spire/cluster1/clusterspiffeid-template.yaml
```
