...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=effb40ffe252034222cb74bc480f486663ca0137
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/effb40ffe252034222cb74bc480f486663ca0137/examples/spire/cluster1/clusterspiffeid-template.yaml
```
