...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=99e9e1c8add44eec865d0f6734f1d71ad89e9b76
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/99e9e1c8add44eec865d0f6734f1d71ad89e9b76/examples/spire/cluster1/clusterspiffeid-template.yaml
```
