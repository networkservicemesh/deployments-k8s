...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=f8e5c8d39f016e7ad4ef4d3cc012efda5b599bef
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/f8e5c8d39f016e7ad4ef4d3cc012efda5b599bef/examples/spire/cluster1/clusterspiffeid-template.yaml
```
