...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=3a14e355d305abd0d63a0319191856cec5ca7b4c
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/3a14e355d305abd0d63a0319191856cec5ca7b4c/examples/spire/cluster1/clusterspiffeid-template.yaml
```
