...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=ea448f0f259cd6d950ae06405f23ffbb86b209ca
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/ea448f0f259cd6d950ae06405f23ffbb86b209ca/examples/spire/cluster1/clusterspiffeid-template.yaml
```
