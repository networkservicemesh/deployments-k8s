...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=81e03c996c8b865169310163ede0c4fc93a1934a
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/81e03c996c8b865169310163ede0c4fc93a1934a/examples/spire/cluster1/clusterspiffeid-template.yaml
```
