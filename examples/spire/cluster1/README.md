...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=caaa625aa303cd2713f514863ec35b5e7f493852
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/caaa625aa303cd2713f514863ec35b5e7f493852/examples/spire/cluster1/clusterspiffeid-template.yaml
```
