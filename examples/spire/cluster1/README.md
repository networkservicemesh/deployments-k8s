...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=1edb4dd050c0ce58794ef8c3bd46c29f29cc16d5
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/1edb4dd050c0ce58794ef8c3bd46c29f29cc16d5/examples/spire/cluster1/clusterspiffeid-template.yaml
```
