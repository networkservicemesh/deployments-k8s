...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=d8ca699bbe50824f81bfca5dea82d4a3622142fd
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/d8ca699bbe50824f81bfca5dea82d4a3622142fd/examples/spire/cluster1/clusterspiffeid-template.yaml
```
