...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=e0ed02196230addadfc806127a493bac1b860ab3
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e0ed02196230addadfc806127a493bac1b860ab3/examples/spire/cluster1/clusterspiffeid-template.yaml
```
