...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster1?ref=9fdf2dadf7f454fb8f057fbf656f75bdcb6b0a52
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9fdf2dadf7f454fb8f057fbf656f75bdcb6b0a52/examples/spire/cluster1/clusterspiffeid-template.yaml
```
