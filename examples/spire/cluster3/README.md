...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster3?ref=1dc475fd944262a817a6880a2f8dd15de8fcf465
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/1dc475fd944262a817a6880a2f8dd15de8fcf465/examples/spire/cluster3/clusterspiffeid-template.yaml
```
