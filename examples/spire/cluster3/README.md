...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster3?ref=5a352a37b2947bd8fa10b998e9c9cdd03508b4a4
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/5a352a37b2947bd8fa10b998e9c9cdd03508b4a4/examples/spire/cluster3/clusterspiffeid-template.yaml
```
