...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster3?ref=56b6cc7a68eefb10e0217b8af9da5cec2a1c595a
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/56b6cc7a68eefb10e0217b8af9da5cec2a1c595a/examples/spire/cluster3/clusterspiffeid-template.yaml
```
