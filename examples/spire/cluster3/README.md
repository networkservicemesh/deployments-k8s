...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster3?ref=81e03c996c8b865169310163ede0c4fc93a1934a
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/81e03c996c8b865169310163ede0c4fc93a1934a/examples/spire/cluster3/clusterspiffeid-template.yaml
```
