...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster3?ref=02fab35bc8a2a36fce9662a72dad3e947fe73fbc
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/02fab35bc8a2a36fce9662a72dad3e947fe73fbc/examples/spire/cluster3/clusterspiffeid-template.yaml
```
