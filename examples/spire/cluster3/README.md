...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/spire/cluster3?ref=58db7eb0ab55b1f6b760bf4721257ebf412de338
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/58db7eb0ab55b1f6b760bf4721257ebf412de338/examples/spire/cluster3/clusterspiffeid-template.yaml
```
