...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/heal/remote-nsm-system-restart-memif-ip
```
...
```
```bash
kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/basic
```
