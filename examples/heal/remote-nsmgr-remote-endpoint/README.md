...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/heal/remote-nsmgr-remote-endpoint/nsmgr-before-death
```
...
```
```bash
kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/heal/remote-nsmgr-remote-endpoint/nsmgr-after-death
```
