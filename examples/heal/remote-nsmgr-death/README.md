...
bases:
- https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=v1.5.0-rc.1
...
Restore NSMgr setup:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=v1.5.0-rc.1 -n nsm-system
```
