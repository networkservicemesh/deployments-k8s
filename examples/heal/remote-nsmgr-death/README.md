...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/heal/remote-nsmgr-death/remote-nse
```
...
Kill remote NSMgr:
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/heal/remote-nsmgr-death/nsmgr-death
```

Start local NSE instead of the remote one:
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/heal/remote-nsmgr-death/local-nse
```
...
Restore NSMgr setup:
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/apps/nsmgr -n nsm-system
```
