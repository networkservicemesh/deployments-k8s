...
bases:
- https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=v1.1.1-rc.2
...
Restore NSMgr setup:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=v1.1.1-rc.2 -n nsm-system
```
