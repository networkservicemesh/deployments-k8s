...
bases:
- https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=v1.1.0
...
Restore NSMgr setup:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=v1.1.0 -n nsm-system
```
