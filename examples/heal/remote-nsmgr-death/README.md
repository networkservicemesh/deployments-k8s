...
bases:
- github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=763c667eeac02957b36ee2d03e8e437e8d51b7cd
...
Restore NSMgr setup:
```bash
kubectl apply -k github.com/networkservicemesh/deployments-k8s/apps/nsmgr?ref=763c667eeac02957b36ee2d03e8e437e8d51b7cd -n nsm-system
```
