...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/heal/registry-restart/registry-before-death
```
...
Apply a new client:
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/heal/registry-restart/registry-after-death
```
