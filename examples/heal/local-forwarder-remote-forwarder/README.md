...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/heal/local-forwarder-remote-forwarder?ref=a0b48c7a4c47f6d22c4d3783bc75d0ca588ff4cf
```
