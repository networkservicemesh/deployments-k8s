...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/heal/local-forwarder-remote-forwarder?ref=25f03e3a5bef7ff08c27b60f1a702a7fc5aad146
```
