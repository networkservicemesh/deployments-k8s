...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/heal/local-forwarder-remote-forwarder?ref=08e97ad2f75f176db8ecaea956e3cb3ffe8336f4
```
