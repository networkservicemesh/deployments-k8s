...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/heal/local-nsm-system-restart?ref=e64edf312d9e7a4e5c8d26c0a0d96ecfeb74364a
```
