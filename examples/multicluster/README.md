...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/multicluster/cluster-configuration/cluster2?ref=592e04c0686c87350d882b4f1642ceca814f0dbb
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/multicluster/cluster-configuration/cluster3?ref=592e04c0686c87350d882b4f1642ceca814f0dbb
```
